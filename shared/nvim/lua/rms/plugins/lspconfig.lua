...
-- organize imports, just like VS Code
...
-- on_attach function to run whenever a language server starts
...
-- enabled formatting on save through a Vim autocommand
...
-- wrapper around command-line tools like eslint
-- using eslint_d
local filetypes = {
    typescript = "eslint",
